...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
 //  The nested function can access the variable because it is a closure. A closure is able to reach out of its scope.
...
console.log(animalNames(zooAnimals))
 ...
 function lowerCaseNames(arr){
    ...
    arr.map(function(item){
      return lower.push(item.animal_name.toLowerCase());
    })
    return lower
  }
...
// dont understand why its logging NaN in my terminal
// 🦄🦄🦄 Topic 4: Classes 🦄🦄🦄 //
